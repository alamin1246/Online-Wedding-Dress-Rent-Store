...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <table width="100%" height="152" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#BCE0A8" style="color:black"><span class="style10">Head Office</span></td>
        <td bgcolor="#BCE0A8" style="color:black"><span class="style10">Branch Office</span></td>
      </tr>
      <tr>
        <td style="color:black">New market<br/>Near Dhaka College<br/>Dhaka</td>


        <td style="color:black">New Market Circle<br/>
         Near Huseyn Shaheed Suhrawardy Road
<br/>
Chattogram</td>
      </tr>
      <tr style="color:black">
        <td>Phone: +8801741223556</td>
        <td>Phone:+8801741145960</td>
      </tr>
      <tr style="color:black">
        <td>Email: sharminshop@gmail.com</td>
        <td>Email: sharminshop@gmail.com</td>
