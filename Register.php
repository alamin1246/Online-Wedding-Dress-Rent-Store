...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <form action="insert.php" method="post" onSubmit="return validateForm(this,arrFormValidation);" enctype="multipart/form-data" name="form2" id="form2">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" onSubmit="return valid();"  style="color:black";>
        <tr>
        ...
        <tr>
          ...
          <td><span  id="user-availability-status">
            <label>
            <input type="text" name="txtUserName" id="txtUserName3" onBlur="checkAvailability()"/>
            </label>
          <span class="textfieldRequiredMsg">A value is required.</span></span></td>
        </tr>
        <tr>
